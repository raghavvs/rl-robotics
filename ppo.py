...
STACK_SIZE = 4  # Update this value based on your stack size
PATH = 'policy_ppo.pt'  # Update this value with the path to your model

def train(env, policy, optimizer, episodes=100):
    writer = SummaryWriter()
...
def main_eval():
    ...
    scores = evaluate(env, policy, episodes=10)
